...
export declare const Prompt: import("styled-components").StyledComponent<(props: PromptProps) => JSX.Element | null, any, {}, never>;
export declare const PromptBuffer: import("styled-components").StyledComponent<(props: PromptProps) => JSX.Element | null, any, {}, never>;
export {};
