...
function (_React$Component) {
  _inherits(MuxVideoPreview, _React$Component);

  function MuxVideoPreview() {
    _classCallCheck(this, MuxVideoPreview);

    return _possibleConstructorReturn(this, _getPrototypeOf(MuxVideoPreview).apply(this, arguments));
  }

  _createClass(MuxVideoPreview, [{
    key: "render",
    value: function render() {
      ...
      var media = posterUrl ? _react.default.createElement("img", {
        src: posterUrl
      }) : null;
...
_defineProperty(MuxVideoPreview, "propTypes", {
