...
//var axios = _interopRequireDefault(require("axios"));
...
_temp = _class = class Editor extends _react.default.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "handlePublishRequested", () => {
     ...
     //axios.post('http://localhost:8000/saveDraft',  JSON.stringify(draft)   )
   /*  axios({
      method: 'post',
      url: 'http://localhost:8000/saveDraft',
      data: JSON.stringify(draft),
      });*/

      axios.post('http://localhost:8000/saveDraft', {
        data: JSON.stringify(draft)
      })

 /*     axios.post('http://18.194.93.123:8000/saveDraft', {
  data: JSON.stringify(draft)
})*/
    });
