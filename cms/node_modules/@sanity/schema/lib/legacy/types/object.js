...
const OVERRIDABLE_FIELDS = ['jsonType', 'orderings', 'type', 'name', 'title', 'readOnly', 'hidden', 'description', '__experimental_search', 'options', 'inputComponent', 'validation'];
...
const ObjectType = {
  ...
  extend(rawSubTypeDef, createMemberType) {
    ...
    (0, _utils.lazyGetter)(parsed, '__experimental_search', () => {
      const userProvidedSearchConfig = subTypeDef.__experimental_search ? normalizeSearchConfig(subTypeDef.__experimental_search) : null;
