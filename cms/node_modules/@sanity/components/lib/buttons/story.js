...
const getColorKinds = () => (0, _knobs.select)('color', [undefined, 'primary', 'success', 'danger', 'white'], undefined, 'props');
...
(0, _storybook.storiesOf)('Buttons', module).addDecorator(_knobs.withKnobs).add('Default', () => {
  ...
  const backgroundColor = (0, _knobs.color)('View color', 'rgba(255, 255, 255, 0', 'test');
  const qtyButtons = (0, _knobs.number)('# buttons', 2, 'test');
  const loading = (0, _knobs.boolean)('Loading', false, 'buttonProp');
  const onlyIcon = (0, _knobs.boolean)('Only icon', false, 'test');
  const icon = (0, _knobs.boolean)('icon', false, 'buttonProp') ? _sanityLogoIcon.default : undefined;
  const buttonText = (0, _knobs.text)('Button text', '', 'buttonProp');
