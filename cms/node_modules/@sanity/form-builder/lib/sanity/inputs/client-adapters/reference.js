...
function search(textTerm, referenceType) {
  const forTypes = (0, _weighted.createWeightedSearch)(referenceType.to, _client.default);
  return forTypes(textTerm).pipe((0, _operators.map)(results => results.map(res => res.hit)));
}