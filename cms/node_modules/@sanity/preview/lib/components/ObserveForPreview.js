...
const connect = props$ => {
  const sharedProps$ = props$.pipe((0, _operators.publishReplay)(1), (0, _operators.refCount)());
  const isActive$ = sharedProps$.pipe((0, _operators.map)(props => props.isActive !== false));
