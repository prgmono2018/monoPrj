...
function Main() {
    ...
    this.do_layout = function (layout) {
        ...
        var tip = '<div style="padding:2em;" class="member-help">Select a method to see the help.</div>';
    ...
    this.show_const_help = function (chain_item) {
        ...
        if (cls_info['class'].help) {
            all_help = cls_info['class'].help.replace(/\\n/g, '\n');
            i = all_help.indexOf('\n');
            if (i > 0) {
        ...
        html += ' {\n';
        if (const_obj.help) {
            html += '\n    <span class="member-help">' + const_obj.help.replace(/\\n/g, '\n    ') + '</span>\n\n';
        } else if (const_obj.inlineHelp) {
            html += '\n    <span class="member-help">' + const_obj.inlineHelp.replace(/\\n/g, '\n    ') + '</span>\n\n';
        }
    ...
    this.show_property_help = function (chain_item) {
        ...
        html += ' {\n';
        if (prop.help) {
            html += '\n    <span class="member-help">' + prop.help.replace(/\\n/g, '\n    ') + '</span>\n\n';
        } else if (prop.inlineHelp) {
            html += '\n    <span class="member-help">' + prop.inlineHelp.replace(/\\n/g, '\n    ') + '</span>\n\n';
        }
    ...
    this.show_method_help = function (chain_item) {
        ...
        // method help
        if (method.help) {
            html += '\n    <span class="member-help">' + method.help.replace(/\\n/g, '\n    ') + '</span>';
        } else if (method.inlineHelp) {
            html += '\n    <span class="member-help">' + method.inlineHelp.replace(/\\n/g, '\n    ') + '</span>';
        }
        ...
        for (j = 0; j < params.length; j += 1) {
            ...
            for (k = 0; k < param.type.length; k += 1) {
                ...
                types += '<span class="link">' + param.type[k] + '</span>';
            }
            html += '\n\n        arg ';
            html += types + ' <b>' + param.name + '</b>';
            html += (param.optional ? ' (optional)' : '');
            html += (param['default'] === null ? '' : ' = ' + param['default']);
            html += '\n\n            <span class="member-help">' + param.help + '</span>';
        }

        // help return
        if (method.returns) {
            html += '\n\n        returns <span class="member-help">' + method.returns.help.replace(/\\n/g, '\n    ') + '</span>';
        }
